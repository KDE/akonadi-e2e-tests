...
When receiving an iTIP invitation, if you have more than one calendar, a popup asking you to select the calendar in which to accept the invitation will appear, which will block the test.

Since this popup cannot be deactivated, it is heavily recommended to not have more calendars than the default one, when testing iTIP invitations.
